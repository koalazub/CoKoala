...
({
    ...
    , expect:
      [["opentag", {
        ...
        , ["opentag", {
        name: "ns1", prefix: "", local: "ns1", uri: "uri:default",
        attributes: {
          "xmlns": {
            name: "xmlns",
            value: "uri:default",
        ...
        , ["attribute", {name: "attr", value: "normal", prefix: "", local: "attr", uri: ""}]
        , ["opentag", {
        name: "plain", prefix: "", local: "plain", uri: "uri:default", ns: {'': 'uri:default'},
        ...
        , ["opentag", {
        name: "a:ns", prefix: "a", local: "ns", uri: "uri:nsa",
