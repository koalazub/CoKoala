...
<head>
  ...
  <meta content="HTML Tidy for Mac OS X (vers 31 October 2006 - Apple Inc. build 13), see www.w3.org" name="generator"/>
  <title>W3C Software Notice and License</title>
  <link href="/2008/site/css/minimum" media="handheld, all" rel="stylesheet" type="text/css"/>
  <style media="print, screen and (min-width: 481px)" type="text/css" xml:space="preserve">
     @import url("/2008/site/css/advanced");
</style>
  <link href="/2008/site/css/minimum" media="handheld, only screen and (max-device-width: 480px)" rel="stylesheet"
        type="text/css"/>
  <meta content="width=device-width" name="viewport"/>
  <link href="/2008/site/css/print" media="print" rel="stylesheet" type="text/css"/>
  <link href="/2008/site/images/favicon.ico" rel="shortcut icon" type="image/x-icon"/>
</head>
...
<div id="w3c_container">
  ...
  <div id="w3c_mast">
    <h1 class="logo">
      <a accesskey="1" href="/" tabindex="2"><img alt="W3C" height="53" src="/2008/site/images/logo-w3c-mobile-lg"
                                                  width="90"/></a>
    ...
    <div id="w3c_nav">
      ...
      <form action="/Help/search" enctype="application/x-www-form-urlencoded" method="get">
        ...
        <ul class="main_nav">
          ...
          <li class="search-item">
            <div id="search-form">
              <input class="text" name="q" tabindex="3" title="Search" type="text" value=""/>
              <button id="search-submit" name="search-submit" type="submit"><img alt="Search"
                                                                                 class="submit"
                                                                                 height="17" src="/2008/site/images/search-button" width="21"/>
              </button>
            </div>
          </li>
        </ul>
  ...
  <div id="w3c_main">
    <div class="w3c_leftCol" id="w3c_logo_shadow">
      <img alt="" height="32" src="/2008/site/images/logo-shadow"/>
    </div>

    <div class="w3c_leftCol"><h2 class="offscreen">Site Navigation</h2>
      <h3 class="category"><span class="ribbon"><a href="/Consortium/Legal/ipr-notice.html"
                                                   title="Up to Policies and Legal Information">Policies and Legal Information <img
        alt="Header link" class="header-link" height="13" src="/2008/site/images/header-link" width="13"/></a></span>
      </h3>
      <ul class="theme">
        ...
        <li><a href="/Consortium/Legal/2002/trademark-license-20021231.html">W3C&#xAE; Trademark and Service Mark
          License</a></li>
        <li><a class="current">W3C Software Notice and License</a></li>
        <li><a href="/Consortium/Legal/2002/collaborators-agreement-20021231.html">W3C Invited Expert and Collaborators
          Agreement</a></li>
        ...
        <li><a href="/Consortium/Legal/2006/08-copyright-translations.html">Translations of the Copyright Notice</a>
        </li>
      </ul>
      <br/></div>
      ...
      <div id="w3c_crumbs">
        <div id="w3c_crumbs_frame">
          <ul class="bct"> <!-- .bct / Breadcrumbs -->
            <li class="skip"><a accesskey="2" href="#w3c_content_body" tabindex="1"
                                title="Skip to content (e.g., when browsing via audio)">Skip</a></li>
            <li><a href="/">W3C</a>&#xA0;<span class="cr">&#xBB;</span>&#xA0;</li>
            <li><a href="/Consortium/">About&#xA0;W3C</a>&#xA0;<span class="cr">&#xBB;</span>&#xA0;</li>
            <li><a href="/Consortium/facts.html">Facts&#xA0;About&#xA0;W3C</a>&#xA0;<span class="cr">&#xBB;</span>&#xA0;
            </li>
        ...
        <div class="line">
          ...
          <ul class="show_items">
            ...
            <li>Any pre-existing intellectual property disclaimers, notices, or terms
              and conditions. If none exist, the <a href="copyright-software-short-notice-20021231.html">W3C Software
                Short
...
<div id="w3c_footer">
  <div id="w3c_footer-inner">
      ...
      <ul class="footer_follow_nav">
        <li>
          <a href="http://twitter.com/W3C" title="Follow W3C on Twitter">
            <img alt="Twitter" class="social-icon" height="83" src="/2008/site/images/twitter-bird" width="78"/>
          </a>
          <a href="http://identi.ca/w3c" title="See W3C on Identica">
            <img alt="Identica" class="social-icon" height="83" src="/2008/site/images/identica-logo" width="91"/>
          </a>
        </li>
      </ul>
    </div>
    ...
    </a>, <a href="http://www.keio.ac.jp/">Keio</a>) <a href="/Consortium/Legal/ipr-notice">Usage policies apply</a>.
    </p>
  </div>
</div><!-- Generated from data/scripts.php, ../../smarty/{scripts.tpl} --><!-- At the bottom for performance reasons -->
<div id="w3c_scripts">
  <script src="/2008/site/js/main" type="text/javascript" xml:space="preserve"><!-- --></script>
</div>
</body>
</html>
