...
var Rule = (function (_super)
  {
    ...
    Rule.prototype.isEnabled = function ()
      {
        var _a = Rule.metadata.options, _b = _a.items, enumTypes = _b[0].enum, enumStyles = _b[2].enum,
          maxLength = _a.maxLength, minLength = _a.minLength;
        ...
        var isTypeArgumentValid = typeArgument.length > 0 && typeArgument.every(function (argument)
        {
          return enumTypes.indexOf(argument) !== -1;
        });
