    ...
    TemplateVisitorCtrl.prototype.visitBoundText = function (text, context)
      {
        ...
        this.visitors
          .filter(function (v)
          {
            return options.indexOf(v.getCheckOption()) >= 0;
          })
          .map(function (v)
          {
            return v.visitBoundText(text, _this);
          })
    ...
    TemplateVisitorCtrl.prototype.visitDirectiveProperty = function (prop, context)
      {
        ...
        this.visitors
          ...
          .map(function (v)
          {
            return v.visitDirectiveProperty(prop, _this);
          })
          .filter(isNotNullOrUndefined_1.isNotNullOrUndefined)
          .forEach(function (f)
          {
    ...
    ExpressionVisitorCtrl.prototype.visitPipe = function (expr, context)
      {
        ...
        this.visitors
          .map(function (v)
          {
            return v.addParentAST(_this.parentAST);
          })
          .filter(function (v)
          {
            return options.indexOf(v.getCheckOption()) >= 0;
