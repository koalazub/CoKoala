...
var Rule = (function (_super)
  {
    ...
    Rule.prototype.apply = function (sourceFile)
      {
        var options = __assign({}, DEFAULT_OPTIONS, this.ruleArguments[0]);
    ...
    Rule.prototype.areOptionsValid = function ()
      {
        ...
        return (ruleArgumentsKeys.every(function (argumentKey)
          {
            return propertiesKeys.indexOf(argumentKey) !== -1;
          }) &&
          ruleArgumentsKeys
            .map(function (argumentKey)
            {
              return ruleArgument[argumentKey];
            })
...
var callbackHandler = function (walkContext, node)
  {
    var _a = walkContext.options, getters = _a.getters, methods = _a.methods, _b = OPTION_PARAMETER_PROPERTIES,
      parameterProperties = _a[_b], parameters = _a.parameters, properties = _a.properties, setters = _a.setters;
    ...
    else if (parameters && typescript_1.isParameter(node) && !typescript_1.isParameterPropertyDeclaration(node)) {
      validateParameterDeclaration(walkContext, node);
    }
    else if (parameterProperties && typescript_1.isParameterPropertyDeclaration(node)) {
...
var canIgnoreDecorator = function (walkContext, decoratorName, optionKey)
  {
    var _a = optionKey, optionValue = walkContext.options[_a];
...
var hasAnyIgnoredDecorator = function (walkContext, decorators, optionKey)
  {
    var nonIgnoredDecoratorNames = decorators
      ...
      {
        return !canIgnoreDecorator(walkContext, decoratorName, optionKey);
      });
