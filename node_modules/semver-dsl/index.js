      ...
      gte: function (version, callback)
        {
          var predicate = function ()
            {
              return semver.gte(target, version) && lastPredicate();
            };
          if (predicate()) {
            callback();
          }
      ...
      lte: function (version, callback)
        {
          var predicate = function ()
            {
              return semver.lte(target, version) && lastPredicate();
            };
          if (predicate()) {
            callback();
          }
      ...
      gt: function (version, callback)
        {
          var predicate = function ()
            {
              return semver.gt(target, version) && lastPredicate();
            };
          if (predicate()) {
            callback();
          }
      ...
      lt: function (version, callback)
        {
          var predicate = function ()
            {
              return semver.lt(target, version) && lastPredicate();
            };
          if (predicate()) {
            callback();
          }
      ...
      eq: function (version, callback)
        {
          var predicate = function ()
            {
              return semver.eq(target, version) && lastPredicate();
            };
          if (predicate()) {
            callback();
          }
      ...
      neq: function (version, callback)
        {
          var predicate = function ()
            {
              return semver.neq(target, version) && lastPredicate();
            };
          if (predicate()) {
            callback();
          }
