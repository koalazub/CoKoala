(function (global, factory) {
    ...
    var NgxExtendedPdfViewerComponent = /** @class */ (function () {
        ...
        NgxExtendedPdfViewerComponent.propDecorators = {
            delayFirstView: [{ type: core.Input }],
            src: [{ type: core.Input }],
            height: [{ type: core.Input }],
            useBrowserLocale: [{ type: core.Input }],
            backgroundColor: [{ type: core.Input }],
            showSidebarButton: [{ type: core.Input }],
            showSidebarOnLoad: [{ type: core.Input }],
            showFindButton: [{ type: core.Input }],
            showPagingButtons: [{ type: core.Input }],
            showZoomButtons: [{ type: core.Input }],
            showPresentationModeButton: [{ type: core.Input }],
            showOpenFileButton: [{ type: core.Input }],
            showPrintButton: [{ type: core.Input }],
            showDownloadButton: [{ type: core.Input }],
            showBookmarkButton: [{ type: core.Input }],
            showSecondaryToolbarButton: [{ type: core.Input }],
            showRotateButton: [{ type: core.Input }],
            showSelectToolButton: [{ type: core.Input }],
            showHandToolButton: [{ type: core.Input }],
            showScrollingButton: [{ type: core.Input }],
            showSpreadButton: [{ type: core.Input }],
            showPropertiesButton: [{ type: core.Input }],
            zoom: [{ type: core.Input }],
            zoomChange: [{ type: core.Output }],
            _mobileFriendlyZoom: [{ type: core.Input }],
            mobileFriendlyZoom: [{ type: core.Input }],
            mobileZoom: [{ type: core.Input }],
            sizeSelector: [{ type: core.ViewChild, args: ['sizeSelector',] }]
        };
